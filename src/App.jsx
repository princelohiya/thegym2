...
const App = () => {
  ...
  const BRAND = {
    ...
    address:
      "Mangu Mohalla, road, near SFS computer, Ghitorni, New Delhi, Delhi 110030",
    phone: "99990 05956",
  };
  ...
  return (
    <div className="bg-black text-white font-sans min-h-screen">
      ...
      {/* HERO */}
      <Hero scrollTo={scrollToSection}></Hero>
      ...
      {/* Pricing Section */}
      <Pricing scrollToSection={scrollToSection}></Pricing>

      {/* Contact Section */}
      <ContactUs isMapError={isMapError}></ContactUs>
      ...
      <footer className="bg-neutral-950 border-t border-neutral-900 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-neutral-400">
          ...
          <p>
            &copy; 2025 {BRAND.name}. Transform your body, elevate your life.
          </p>
        </div>
      </footer>
